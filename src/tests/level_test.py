...
class TestLevel(unittest.TestCase):
    def setUp(self):
        ...
        self.level_2 = Level(LEVEL_MAP_2, CELL_SIZE)
    ...
    def test_can_move_box(self):
        ...
        self.level_1.move_robot(dx=-CELL_SIZE)
        self.assert_coordinates_equal(robot, 2 * CELL_SIZE, 2 * CELL_SIZE)
        self.assert_coordinates_equal(box, CELL_SIZE, 2 * CELL_SIZE)
    ...
    def test_can_not_move_box_through_boxes(self):
        ...
        self.level_1.move_robot(dx=-CELL_SIZE)
        self.assert_coordinates_equal(robot, 3 * CELL_SIZE, 2 * CELL_SIZE)
        self.assert_coordinates_equal(box_1, CELL_SIZE, 2 * CELL_SIZE)
        self.assert_coordinates_equal(box_2, 2 * CELL_SIZE, 2 * CELL_SIZE)
